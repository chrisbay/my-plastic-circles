...
insert into Disc (id, model, manufacturer_id, speed, glide, turn, fade, is_favorite, notes) values (hibernate_sequence.nextval, 'Avenger SS', 1, 10, 5, -3, 1, true, 'Z-line swirl plastic');
